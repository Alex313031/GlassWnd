...
# Compiler flags #
DEFINES  := -DUNICODE -D_UNICODE -D_WINDOWS -DWINVER=0x0600 -D_WIN32_WINNT=0x0600 -D_WIN64_WINNT=0x0600 -D_WIN32_IE=0x800 -DPSAPI_VERSION=1
...
CFLAGS   := $(DEFINES) -Wall -static -static-libgcc -municode -Wno-int-conversion
...
# Libraries
LIBS     := -lkernel32 -luser32 -lcomctl32 -lcomdlg32 -lshell32 -lgdi32 -ladvapi32 -lole32 -loleaut32 -luuid -lodbc32 -lodbccp32 -lversion -lpsapi -luxtheme -ldwmapi
# Linker flags
